...
# Test deployment - Added comment
# Monitors IRCC's Express Entry draw data and notifies Airtable of new draws
...
# Constants
WEBHOOK_URL = "https://hooks.airtable.com/workflows/v1/genericWebhook/app5hWVKPlStkpYKs/wflGZBDnnrq2jGAQI/wtrJnl8QUpLkSKhJO"
S3_BUCKET = "immiwatch-lambda-tracker"
